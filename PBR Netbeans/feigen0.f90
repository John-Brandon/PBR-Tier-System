...
!*                                                                    *
!*====================================================================*
parameter(basis = 2)       !Floating point basis of used CPU
real*8 b2, r, c, f, g, s
...
real*8 FUNCTION Comabs        &  !Complex absolute value ..........
              (ar,            &  !Real part .......................
               ai             &  !Imaginary part ..................
              )
real*8 ar,ai
...
integer high, rc
real*8  h(0:n,0:n), wr(0:n),wi(0:n),eivec(0:n,0:n)
!*====================================================================*
!*                                                                    *
...
!*====================================================================*
  integer code, en
  real*8  p, q, r, s, t, w, x, y, z, ra, sa, vr, vi, norm, temp
  ...
  do while (j>=low)
    if (j<=high) then
	  ...
	  m = high  !bug corrected 02/06/2013 (m=high instead of j=high)
    end if 
    if (wi(j) < ZERO) then
      l=j-1
      do i = low, high
...
integer vec,ev_norm,rc,cnt(0:n)
real*8  mat(0:n,0:n),eivec(0:n,0:n), valre(0:n),valim(0:n)
!**********************************************************************
!*                                                                    *
