...
${OBJECTDIR}/BRENT.o: BRENT.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/BRENT.o BRENT.f90

${OBJECTDIR}/DGEEV_and_dependencies.o: DGEEV_and_dependencies.f 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/DGEEV_and_dependencies.o DGEEV_and_dependencies.f
...
${OBJECTDIR}/Initialize_pop_module.o: Initialize_pop_module.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/Initialize_pop_module.o Initialize_pop_module.f90
...
${OBJECTDIR}/PBR_calcs_module.o: PBR_calcs_module.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/PBR_calcs_module.o PBR_calcs_module.f90
...
${OBJECTDIR}/feigen0.o: feigen0.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/feigen0.o feigen0.f90
